...
<div class="content-wrapper">
    <form method="POST" id="save_widget" action="{{ route('admin.widgets.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="widget_code" placeholder="Widget Code" name="widget_code">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" id="message" placeholder="Widget Description" name="description"></textarea>
